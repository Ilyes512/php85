...
The image name scheme: `ghcr.io/specsnl/php85[/{VARIANT}][/{TARGET}]:{VERSION}`
...
```
docker build --tag ghcr.io/specsnl/php85:latest --file fpm/Dockerfile --target runtime .
```
